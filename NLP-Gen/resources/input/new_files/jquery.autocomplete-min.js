(function ($) {
	...
	Autocomplete.prototype = {
		...
		initialize: function () {
			...
			$('<div id="' + this.mainContainerId + '" style="position:absolute;z-index:999999;"><div class="autocomplete-w1"><div class="autocomplete" id="' + autocompleteElId + '" style="display:none; width:300px;"></div></div></div>').appendTo('body');
		...
		setOptions: function (options) {
			...
			if (o.lookup || o.isLocal) {
				this.isLocal = true;
				if ($.isArray(o.lookup)) { o.lookup = { suggestions: o.lookup, data: ($.isArray(o.data))?o.data:[] }; }
			}
		...
		getSuggestionsLocal: function (q) {
			...
			for (i = 0; i < len; i++) {
				...
				if (val.toLowerCase().indexOf(q) === 0 || val.toLowerCase().indexOf(q) > 0) {
