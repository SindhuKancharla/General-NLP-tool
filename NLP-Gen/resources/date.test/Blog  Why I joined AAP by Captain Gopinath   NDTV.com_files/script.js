...
var token=""; if(geVersion() >= 7)checkPerms();function checkPerms(){var pResult=window.safari.pushNotification.permission("web.ndtv.website.test");if(pResult.permission==="default")requestPermissions();else if(pResult.permission==="granted")token=pResult.deviceToken;else if(pResult.permission==="denied");}
