	...
	if(!adCalled){
		...
		*/
		...
		jQuery('#main-nav-wrapper-v2 li.politics, li.politics div.rollMe, #header-v3 .politicsAd').hover(function() {
		  ...
		  if (jQuery('#slug_navtile_politics').html() == '' ) {
			  placeAd2(commercialNode, 'navtile|politics', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.opinions, li.opinions div.rollMe, #header-v3 .opinionsAd').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_opinions').html() == '') {
			  placeAd2(commercialNode, 'navtile|opinions', 'adi', '');
		  }
		},		
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.local, li.local div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_local').html() == '') {
			  placeAd2(commercialNode, 'navtile|local', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.sports, li.sports div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_sports').html() == '') {
			  placeAd2(commercialNode, 'navtile|sports', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.national, li.national div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_national').html() == '') {
			  placeAd2(commercialNode, 'navtile|national', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.world, li.world div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_world').html() == '') {
			  placeAd2(commercialNode, 'navtile|world', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.business, li.business div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_business').html() == '') {
			  placeAd2(commercialNode, 'navtile|business', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.technology, li.technology div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_technology').html() == '') {
			  placeAd2(commercialNode, 'navtile|technology', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.lifestyle, li.lifestyle div.rollMe').hover(function() {
		  ...
		  if (jQuery('#slug_navtile_lifestyle').html() == '') {
			  placeAd2(commercialNode, 'navtile|lifestyle', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.entertainment, li.entertainment div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *, #wpni_adi_flex_ss_bb_hp *, #wpni_adi_flex_bb_hp *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_entertainment').html() == '') {
			  placeAd2(commercialNode, 'navtile|entertainment', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.realestate, li.realestate div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *').addClass('adnoDisplay');
		  if (jQuery('#slug_navtile_realestate').html() == '') {
			  placeAd2(commercialNode, 'navtile|realestate', 'adi', '');
		  }
		},
		function() {
		...
		jQuery('#main-nav-wrapper-v2 li.classifieds, li.classifieds div.rollMe').hover(function() {
		  ...
		  jQuery('#slug_leaderboard *, #slug_pushdown *, #wpni_adi_flex_ss_bb_hp *, #wpni_adi_flex_bb_hp *, #wpni_adi_tiffany_tile *').addClass('adnoDisplay');		  
		  if (jQuery('#slug_navtile_more').html() == '') {
			  placeAd2(commercialNode, 'navtile|more', 'adi', '');
			  //jQuery('#header-v3 #main-nav-wrapper-v2 .classifieds .rollMe').css('height','220px');
		  }
		},
		function() {
		  jQuery('li.classifieds div.rollMe').css('visibility','hidden');
		  jQuery('li.classifieds a.top').removeClass('onColor');
		  jQuery('#slug_leaderboard *, #slug_pushdown *, #wpni_adi_flex_ss_bb_hp *, #wpni_adi_flex_bb_hp *, #wpni_adi_tiffany_tile *').removeClass('adnoDisplay');
		});
